...
public class Simulator {
    ...
    private List<AnimalProperties> animals;
    ...
    public void simulateOneStep() {
        ...
        List<AnimalProperties> newAnimals = new ArrayList<>();
        // Let all rabbits act.
        for (Iterator<AnimalProperties> it = animals.iterator(); it.hasNext(); ) {
    ...
    public void reset() {
        step = 0;
        animals.clear();
        new FieldPopulation().populate(field, animals);
